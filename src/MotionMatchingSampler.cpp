...
std::vector<Feature> MotionMatchingSampler::relativize_sample(Sample& sample) const
{
    ...
    sample.current_feature.left_foot_position = current_left_foot_pos_clip_space - current_root_pos_clip_space;
    sample.current_feature.right_foot_position = current_right_foot_pos_clip_space - current_root_pos_clip_space;
    ...
    {
        past_feature.root_position = past_feature.root_position - current_root_pos_clip_space;
        past_feature.left_foot_position = past_feature.left_foot_position - current_root_pos_clip_space;
        past_feature.right_foot_position = past_feature.right_foot_position - current_root_pos_clip_space;
    ...
    {
        future_feature.root_position = future_feature.root_position - current_root_pos_clip_space;
        future_feature.left_foot_position = future_feature.root_position - current_root_pos_clip_space;
        future_feature.right_foot_position = future_feature.root_position - current_root_pos_clip_space;
